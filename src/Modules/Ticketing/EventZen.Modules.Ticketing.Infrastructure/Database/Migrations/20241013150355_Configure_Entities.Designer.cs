...
namespace EventZen.Modules.Ticketing.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241013150355_Configure_Entities")]
    partial class Configure_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.HasOne("EventZen.Modules.Ticketing.Domain.Events.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.HasOne("EventZen.Modules.Ticketing.Domain.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventZen.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("EventZen.Modules.Ticketing.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("EventZen.Modules.Ticketing.Domain.Events.TicketType", null)
                        .WithMany()
